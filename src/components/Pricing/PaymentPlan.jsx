...
import styles from "./Pricing"
import check from "../../assets/Images/Icon.jpg"

const paymentPlan = (props) => {
    const {bgColor,fntColor,setBorder, checkIcon1, checkIcon2, checkIcon3, checkIcon4, checkIcon5, checkIcon6, title, subTitle, price, feature1, feature2, feature3, feature4, feature5, feature6} = props;
